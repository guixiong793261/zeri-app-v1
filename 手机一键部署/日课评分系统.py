...
class DayScoreWindow:
    ...
    def create_widgets(self):
        ...
        main_canvas = tk.Canvas(main_frame_container)
        ...
        # 标题
        title_label = tk.Label(self.main_frame, text="专业级日课评分系统", 
                               font=("微软雅黑", 18, "bold"), bg='white', fg='black')
        ...
        # 事主信息区域（放在最上方）
        self.owners_frame = ttk.LabelFrame(self.main_frame, text="事主信息", padding="10")
        self.owners_frame.pack(fill=tk.X, pady=5, padx=20)
        self.update_owners_frame()
        ...
        # 输入区域
        input_frame = ttk.LabelFrame(left_frame, text="日课输入", padding="10")
