...
try:
    ...
    from .修造神煞扩展 import ConstructionShenShaCheckerExt
    ...
    try:
        ...
        print(f"导入神煞模块失败: {e}")
        # 如果仍然失败，使用空实现
        class CommonShenShaChecker:
            pass
        class MarriageShenShaChecker:
            pass
        class ConstructionShenShaChecker:
            pass
        class StoveShenShaChecker:
            pass
        class OpeningShenShaChecker:
            pass
        class TravelShenShaChecker:
            pass
        class BurialShenShaChecker:
            pass
        class BedShenShaChecker:
            pass
        class RuZhaiShenShaChecker:
            pass
